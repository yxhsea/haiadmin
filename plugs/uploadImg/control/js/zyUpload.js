		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
		            ...
		            html += '				</div>';
		            html += '			</div>';
					html += '			<div id="preview" class="upload_preview" style="overflow: inherit;"></div>';
					html += '		</div>';
		            ...
		            html += '				</div>';
		            html += '			</div>';
		            html += '			<div id="preview" class="upload_preview" style="overflow: inherit;">';
				    ...
				    html += '							<img class="upload_image" id="add_upload" src="" style="width:expression(this.width > '+imgWidth+' ? '+imgWidth+'px : this.width)" />';
				    html += '						</div>';
				    html += '					</a>';
				    html += '				</div>';
					html += '			</div>';
...
//				}
			...
			this.funDisposePreviewHtml = function(file, e){
				...
				//}
				//if(para.del){  // 显示删除按钮
					delHtml = '<span class="file_del force_del" data-index="'+file.index+'" title="删除"></span>';
				//}
				...
				if (file.type.indexOf("image") == 0) {
					...
					html += '	<div class="file_bar file_hover" style="opacity: 0.4;">';
					...
					html += '			<img id="uploadImage_'+file.index+'" data-id="" class="upload_image yxh_upload_image" src="' + e.target.result + '" style="width:expression(this.width > '+imgWidth+' ? '+imgWidth+'px : this.width);" />';
					html += '		</div>';
					html += '	</a>';
